...
<%
    ...
    try{
        ...
        out.println("<body>");
        out.println("<h1  style=\"background-color:darkred; text-align:center; font-size: 30px; width: 700px; margin: 0 auto; color: white;\">Invalid password or username.Try again!</h1>");
        out.println("</body>");
        out.println("</html>");
